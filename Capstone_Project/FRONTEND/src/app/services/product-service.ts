...
// @Injectable({ providedIn: 'root' })
// export class ProductService {
//   /** API Gateway → forwards /product/** to ProductMS:9001 */
//   private gwUrl = 'http://localhost:8080/product';
...
//   // ===== LIST / GET =====
//   getAllProducts(): Observable<Product[]> {
//     return this.http.get<Product[]>(this.gwUrl);
//   }

//   getProductById(id: number): Observable<Product> {
//     return this.http.get<Product>(`${this.gwUrl}/${id}`);
//   }

//   search(
//     field: 'name' | 'description' | 'category' | 'make' | 'price',
//     q: string,
//     page = 0,
//     size = 10
//   ): Observable<PageResponse<Product>> {
...
//       .set('page', String(page))
//       .set('size', String(size));
//     return this.http.get<PageResponse<Product>>(`${this.gwUrl}/search`, { params });
//   }

//   // ====== NEW: CRUD for Admin Dashboard ======
//   createProduct(p: Product): Observable<Product> {
//     return this.http.post<Product>(this.gwUrl, p);
//   }

//   updateProduct(id: number, p: Product): Observable<Product> {
//     return this.http.put<Product>(`${this.gwUrl}/${id}`, p);
//   }

//   deleteProduct(id: number): Observable<void> {
//     return this.http.delete<void>(`${this.gwUrl}/${id}`);
//   }
// }
